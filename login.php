...
if(password_verify($password, $user['password'])){
    if($user['role']=="vet" && $user['status']!="approved"){
...
<head>
    ...
    <title>Login | Pamper Your Pet</title>
        ...
        * {
        ...
        .login-hero {
            background: linear-gradient(135deg, rgba(15, 43, 70, 0.95), rgba(31, 77, 120, 0.88)),
                url('https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&w=1200&q=80') center/cover;
            color: #ffffff;
            border-radius: 22px;
            padding: 28px;
            display: grid;
        ...
        <nav>
            ...
            <div class="auth-buttons">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <a href="pet-parent-dashboard.php" class="btn btn-login">My Dashboard</a>
        ...
        <div class="login-layout">
            <section class="login-hero">
                <div>
                    ...
                    <h1>Continue caring with confidence.</h1>
                    <p>Access your appointments, records, and care plans in one place.</p>
                </div>
                <ul class="hero-list">
                    <li>View upcoming visits and treatment history</li>
</ul>
            </section>
