...
<head>
    ...
    <title>Verify OTP | Pamper Your Pet</title>
    ...
    <div class="container">
        ...
        <div class="auth-layout">
            <section class="auth-hero">
                <div>
                    <span class="section-tag">Verify Your Code</span>
                    <h1>Confirm your identity.</h1>
                    <p>Enter the one-time password sent to your email to continue.</p>
                </div>
                <ul class="hero-list">
                    <li>OTP valid for a short time only</li>
                    <li>Check spam or promotions if needed</li>
            ...
            <section class="form-card">
                ...
                <div class="form-footer">
                    Need a new code? <a href="forget-password.php">Resend OTP</a>
                </div>
            </section>
        </div>
    </div>
